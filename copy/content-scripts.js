...
var StateController = /** @class */ (function () {
    ...
    StateController.prototype.set = function (id, obj) {
        if (!this.data[id])
            this.data[id] = {};
        this.data[id] = Object.assign(this.data[id], obj);
    };
    StateController.prototype.get = function (id, type) {
        var _a, _b, _c;
        return type ? (_b = (_a = this.data) === null || _a === void 0 ? void 0 : _a[id]) === null || _b === void 0 ? void 0 : _b[type] : (_c = this.data) === null || _c === void 0 ? void 0 : _c[id];
    };
    StateController.prototype.notify = function (type) {
        if (type === void 0) { type = 'error_log'; }
        // @ts-ignore next-line
        chrome.runtime.sendMessage({ type: type, state: state.data });
    };
...
// }
var isReady = false;
var onReady = function () { return __awaiter(_this, void 0, void 0, function () {
    var proxy, inject;
        ...
        switch (_a.label) {
            case 0:
                ...
                proxy = new Proxy(options, {
                    set: function (target, propKey, value, receiver) {
                        if (propKey === 'clear-disabled' && (value === null || value === void 0 ? void 0 : value.enable)) {
                            clearDisable();
                        }
            ...
            case 1:
                ...
                chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
                    if ((request === null || request === void 0 ? void 0 : request.type) === "getPageData") {
                        sendResponse(state.get(request === null || request === void 0 ? void 0 : request.id));
                    }
                    if ((request === null || request === void 0 ? void 0 : request.type) === "clearLog") {
                        state.set(request === null || request === void 0 ? void 0 : request.id, { log: undefined });
                        state.notify();
                    }
                });
                return [2 /*return*/];
